                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('anggota.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="prodi" @error('prodi') is-invalid @enderror" value="{{ old('prodi') }}">
                                @error('prodi')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="no_telp" placeholder="08xxxxxxx" @error('no_telp') is-invalid @enderror" value="{{ old('no_telp') }}">
                                @error('no_telp')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input type="file" name="resume" @error('resume') is-invalid @enderror" value="{{ old('resume') }}">
                                @error('resume')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input type="file" name="transkip" @error('transkip') is-invalid @enderror" value="{{ old('transkip') }}">
                                @error('transkip')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input type="file" name="surat_rekomendasi" @error('surat_rekomendasi') is-invalid @enderror" value="{{ old('surat_rekomendasi') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input type="file" name="sertifikat" @error('sertifikat') is-invalid @enderror" value="{{ old('sertifikat') }}">
                                @error('sertifikat')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
