                ...
                <div class="card-body">
                    <form action="{{ route('admin-service.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 col-sm-6">
                            <label>Nama</label>
                            <input class="form-control" type="text" name="nama" value="{{ $service->nama }}">
                            <br>
                        </div>
                        <div class="col-12 col-sm-6">
                            <label>Nim</label>
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <label>Hari</label>
                            <input class="form-control" type="date" name="hari" value="{{ $service->hari }}">
                        </div>
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <label>no_hp</label>
                            <input class="form-control" type="text" name="no_hp" value="{{ $service->no_hp }}">
                        </div>
                        <div class="col-12 col-sm-6">
                            <label>Sesi</label>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 mt-3 mt-sm-3">
                                <a class="card-profile-image mt-4" href="{{asset('images/service/'. $service->foto)}}" target="_blank">
