...
<div class="container border">
    <div class="d-grid gap-1">
        <a button type="button" class="btn btn-primary" id="liveToastBtn" href="{{ route('admin-prestasi.create') }}">Tambah Jadwal</a>
    </div>
            ...
            <table class="table table-flush" id="products-list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-sm">
                            <a href="{{ route('admin-service.edit', $item->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
