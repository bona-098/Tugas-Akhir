    ...
    <div class="container mb-5">
        <div class="row g-5 bd">
            <div class="col-md-6 col-lg-12 bd">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">Perencaan Program Kerja</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="penanggung_jawab"
                                        @error('penanggung_jawab') is-invalid @enderror"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="tujuan_kegiatan"
                                        @error('tujuan_kegiatan') is-invalid @enderror"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="objek_segmentasi"
                                        @error('objek_segmentasi') is-invalid @enderror"
                                        value="{{ old('objek_segmentasi') }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="kebutuhan_lain"
                                        @error('kebutuhan_lain') is-invalid @enderror"
                                        value="{{ old('kebutuhan_lain') }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="value">
                                        <select class="form-select" name="kepengurusan_id"
